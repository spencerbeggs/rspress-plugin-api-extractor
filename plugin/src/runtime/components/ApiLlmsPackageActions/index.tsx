...
// ---------------------------------------------------------------------------
// Title mode: button + dropdown styled like RSPress's LlmsViewOptions
// ---------------------------------------------------------------------------

// biome-ignore lint/correctness/noUnusedVariables: reserved for future title-mode placement
function TitlePackageActions({ scope }: { scope: ApiScope }): ReactElement {
			...
			{isOpen && (
				<div className="rp-llms-view-options__menu">
					...
					<button
						...
						onClick={(e) => {
							e.stopPropagation();
							handleCopyLink(scope.llmsFullTxt);
						}}
					>
						<span className="rp-llms-view-options__item-icon">
							<LinkIcon />
						</span>
						<span>Copy llms-full.txt link</span>
					</button>
					<a
						className="rp-llms-view-options__menu-item"
						href={`https://chatgpt.com/?${new URLSearchParams({ hints: "search", q })}`}
					...
					>
						...
						<span>Open {scope.name} in ChatGPT</span>
						<span className="rp-llms-view-options__external-icon">
							<ExternalLinkSmallIcon />
						</span>
					</a>
					...
					>
						...
						<span>Open {scope.name} in Claude</span>
						<span className="rp-llms-view-options__external-icon">
							<ExternalLinkSmallIcon />
						</span>
					</a>
